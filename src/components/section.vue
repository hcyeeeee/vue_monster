  ...
  <div class="layout" id="section">
      ...
      <ol>
        <li>
          <div v-on:click="modal_1 = !modal_1">
            ...
            <img class="timeimg" src="../assets/man1.png" />

          </div>
        </li>
        <li>
          <div v-on:click="modal_2 = !modal_2">
            <img class="timeimg" src="../assets/man2.png" />
        ...
        <li>
          <div v-on:click="modal_3 = !modal_3">
            ...
            <img class="timeimg" src="../assets/man3.png" />

          </div>
        </li>
        <li>
          <div v-on:click="modal_4 = !modal_4">
            <img class="timeimg" src="../assets/man4.png" />
        ...
        <li>
          <div v-on:click="modal_5 = !modal_5">
            ...
            <img class="timeimg" src="../assets/man5.png" />
          </div>
        </li>
        <li>
          <div v-on:click="modal_6 = !modal_6">
            <img class="timeimg" src="../assets/man6.png" />
    ...
    <section class="timeline mobile2">
      <div class="container right">
        <div v-on:click="modal_1 = !modal_1">
          <time class="time">康熙24年</time>
          <img class="timeimg2" src="../assets/man1.png" />
      ...
      <div class="container right">
        <div v-on:click="modal_2 = !modal_2">
          <time class="time">1887年</time>
          <img class="timeimg2" src="../assets/man2.png" />
      ...
      <div class="container right">
        <div v-on:click="modal_3 = !modal_3">
          <time class="time">1890年</time>
          <img class="timeimg2" src="../assets/man3.png" />
      ...
      <div class="container right">
        <div v-on:click="modal_4 = !modal_4">
          <time class="time">1936年</time>
          <img class="timeimg2" src="../assets/man4.png" />
      ...
      <div class="container right">
        <div v-on:click="modal_5 = !modal_5">
          <time class="time">1952年</time>
          <img class="timeimg2" src="../assets/man5.png" />
        </div>
      </div>
      <div class="container right">
        <div v-on:click="modal_6 = !modal_6">
          <time class="time">1965年</time>
          <img class="timeimg2" src="../assets/man6.png" />
    ...
    <!-- 2 -->
    <div class="c-modal container" v-show="modal_2">
      <!-- computer version -->
      <div class="row computer">
        ...
        <div class="row col-12 content">
          ...
          <div class="row ">
            <p class="col-12">一、台南孔廟<br>
              ...
              里見醫院為當時台南署立醫院院長里見四郎，晚年開設的私人醫院，可惜在歷史資料中無法得知正確位置，但過去民族二路是條大水溝，凹地在水溝兩側，從此可推測林投姐祠應該就在附近。
              <br>
              <img src="../assets/台南孔廟-googlemap.png" class="col-12 travel" alt="">
            ...
            <img src="../assets/辜婦媽廟-官方粉專2.jpeg" class="col-12 travel" alt="">
            <p class="col-6">台南孔廟示意圖</p>
          </div>
          <div class="row">
    ...
    <!-- 4 -->
    <div class="c-modal container" v-show="modal_4">
      <!-- computer version -->
      <div class="row computer">
      ...
      <div class="row mobile">
        ...
        <div class="row col-12 content">
          ...
          <div class="row  mb-5">
            ...
            <img src="../assets/南港大坑.jpg" class="col-12 travel" alt="">
            <p>南港魔神仔硿示意圖</p>
            <img src="../assets/平溪魔神仔洞-googlemap.png" class="col-12 travel" alt="">
            <p>平溪魔神仔洞示意圖</p>
          </div>
      ...
      <div class="row computer">
        ...
        <div class="row col-7 content">
          ...
          <div class="row mt-2">
            ...
            <img src="../assets/將軍廟-頭城新建里將軍廟臉書.jpg" class="col-5 travel" alt="">
            <p class="col-6"></p>
    ...
    <!-- 6 -->
    <div class="c-modal container" v-show="modal_6">
      <!-- computer version -->
      <div class="row computer">
